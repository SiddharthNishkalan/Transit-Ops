...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Digitize fleet, drivers, trips, maintenance, fuel and analytics in one operations platform." },
      { property: "og:title", content: "TransitOps — Smart Transport Operations" },
      { property: "og:description", content: "Centralized transport operations platform for fleet managers, drivers, safety officers and finance." },
